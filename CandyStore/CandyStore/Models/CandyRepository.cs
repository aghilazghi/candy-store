    ...
    public class CandyRepository : ICandyRepository
    {
        ...
        public IEnumerable<Candy> GetAllCandies => new List<Candy> 
        {
            ...
            new Candy 
            {
                ...
                Price = 5.95M, 
                Description="Rhoncus aenean vel elit scelerisque mauris. Etiam sit amet nisl purus. " +
                "Tortor at auctor urna nunc id cursus metus. In hendrerit gravida rutrum quisque non " +
                "tellus orci ac auctor. Lobortis elementum nibh tellus molestie nunc non blandit massa. " +
                "Blandit volutpat maecenas volutpat blandit aliquam etiam. Integer feugiat scelerisque " +
                "varius morbi enim nunc faucibus a pellentesque. Id diam maecenas ultricies mi eget " +
                "mauris. Viverra mauris in aliquam sem. Nisl purus in mollis nunc. A scelerisque" +
                " purus semper eget. Neque ornare aenean euismod elementum nisi quis. Aliquet eget" +
            ...
            new Candy 
            {
                ...
                Price = 3.95M, 
                Description="Nisl suscipit adipiscing bibendum est ultricies integer. Fringilla est ullamcorper " +
                "eget nulla facilisi etiam. Convallis a cras semper auctor neque vitae tempus quam. Lacus " +
                "vestibulum sed arcu non odio. Faucibus purus in massa tempor nec feugiat nisl pretium " +
                "fusce. Nibh sed pulvinar proin gravida. Tortor at auctor urna nunc id cursus. Malesuada " +
                "nunc vel risus commodo. Gravida cum sociis natoque penatibus et magnis dis parturient " +
                "montes. Donec adipiscing tristique risus nec feugiat in fermentum posuere urna. Amet " +
                "commodo nulla facilisi nullam vehicula ipsum a arcu. Mattis nunc sed blandit libero " +
                "volutpat. Ipsum dolor sit amet consectetur adipiscing.", 
